...
resource "aws_route_table_association" "vook_rails_public_route" {
  subnet_id      = aws_subnet.vook_rails_public_subnet_1a.id
  route_table_id = aws_route_table.vook_rails_public_route.id
}
...
resource "aws_route_table_association" "vook_rails_private_route" {
  subnet_id      = aws_subnet.vook_rails_private_subnet_1a.id
  route_table_id = aws_route_table.vook_rails_private_route.id
}
